...
--
-- Ketidakleluas1aan untuk tabel pelimpahan (Dumped Tables)
--

--
-- Ketidakleluas1aan untuk tabel `lamar_pekerjaan`
--
ALTER TABLE `lamar_pekerjaan`
...
--
-- Ketidakleluas1aan untuk tabel `user_sub_menu`
--
ALTER TABLE `user_sub_menu`
